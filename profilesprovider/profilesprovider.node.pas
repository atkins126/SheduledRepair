...
type
  TNodeProfilesProvider = class (TCommonProfilesProvider)
  protected
...
{ TNodeProfilesProvider }

function TNodeProfilesProvider.LoadObjectsTableName : String;
begin
  Result := '';
end;

function TNodeProfilesProvider.GetDefaultProfile : TRendererObjectProfile;
begin
  Result := TRendererObjectProfile.Create(-1, nil);

  { Create node default profile. }
