...
procedure TJobTestCase.Test_Job_Delete;
var
  job : TJob;
  id : Int64;
begin
  ...
  AssertTrue('Job object delete error', job.Delete);
  AssertTrue('Job object impossible load', not job.Load);
